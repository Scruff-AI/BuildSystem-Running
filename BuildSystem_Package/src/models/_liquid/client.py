"""Liquid model client implementation via OpenRouter."""
...
class LiquidChatCompletionClient:
    """Client for Liquid's chat completion API via OpenRouter."""
    ...
    def __init__(self, model: str, api_key: str):
        ...
        self.backup_models = [
            os.getenv("LIQUID_BACKUP_1", "openrouter/google/gemini-flash-1.5"),
            os.getenv("LIQUID_BACKUP_2", "openrouter/meta-llama/llama-2-70b-instruct")
        ]
        self.logger = model_logger.getChild("liquid")
